...
#        {"ok": DecisionLeaf("GO"), "low": DecisionLeaf("EAT"), "high": DecisionLeaf("SLEEP")}),
#        "west": DecisionFork("energy",
#        {"ok": DecisionLeaf("SWIM"), "low": DecisionLeaf("SLEEP"), "high": DecisionLeaf("JUMP")}),
#        "east": DecisionFork("energy",
#        {"ok": DecisionLeaf("SWIM"), "low": DecisionLeaf("EAT"), "high": DecisionLeaf("SLEEP")})})
